...
| Aspect | Ours: [Q16 Evo2 LoRA](notebooks/Q16-lora-continuation.ipynb) | AlphaMissense | REVEL | EVE | PrimateAI-3D | SIFT4G | PolyPhen-2 HumVar |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Core approach | DNA foundation model with two adapted layers and a fixed linear classifier | AlphaFold-derived neural network | Random forest ensemble | Protein-family variational autoencoder, then Gaussian mixture scoring | 3D convolutional neural network | Conservation-based substitution scoring | Naïve Bayes classifier |
| Biological information | Reference/alternate 512-base DNA windows; evolutionary information learned during pretraining | Protein sequence alignments, evolutionary conservation and learned structural representations | Functional-effect and conservation scores from 13 tools | Aligned sequences of related proteins; dependencies between amino-acid positions | 3D protein structure and multiple-sequence alignments | Protein multiple-sequence alignments; amino-acid conservation | Protein sequence conservation and structural features |
| Task-specific training evidence | 46,888 ClinVar variants, after Evo2 pretraining | Human/primate population variation, building on AlphaFold pretraining | HGMD disease variants versus rare presumed-neutral variants | Unsupervised learning of natural protein sequences | Millions of tolerated human/primate variants; auxiliary sequence/structure learning tasks | Amino-acid frequencies in related proteins | [HumVar](https://genetics.bwh.harvard.edu/downloads/pph2/training/): disease/function variants versus common neutral human variants |
| Clinical-label use | ClinVar labels for classifier/adapter fitting, development selection and evaluation; no untouched final test | Core model avoids clinical labels; [released scores and thresholds use ClinVar calibration](https://www.ebi.ac.uk/training/online/courses/alphafold/classifying-the-effects-of-missense-variants-using-alphamissense/understanding-pathogenicity-scores-from-alphamissense/) | Disease labels in training; constituent tools bring their own training histories; ClinVar overlap unresolved | No clinical labels required for fitting/scoring; ClinVar used for evaluation | No clinical annotations for core training; ClinVar used for benchmarking | No clinical-label fitting in core scoring | Disease/function labels in training; ClinVar overlap unresolved |
| AUROC [95% CI] | 0.872 [0.859–0.884] | 0.962 [0.956–0.967] | 0.974 [0.970–0.978] | 0.909 [0.889–0.925] | Not evaluated locally | 0.878 [0.865–0.890] | 0.894 [0.883–0.905] |
| Average precision [95% CI] | 0.801 [0.769–0.828] | 0.940 [0.923–0.951] | 0.958 [0.945–0.968] | 0.916 [0.889–0.935] | Not evaluated locally | 0.772 [0.734–0.804] | 0.822 [0.781–0.852] |
| Coverage of our 17,927 variants | 17,927 — 100% | 16,884 — 94.2% | 17,720 — 98.8% | 9,284 — 51.8% | Unavailable; licensed data needed | 16,917 — 94.4% | 16,430 — 91.6% |
| Scored / validation | 17,927 / 17,927 | 16,884 / 17,927 | 17,720 / 17,927 | 9,284 / 17,927 | — | 16,917 / 17,927 | 16,430 / 17,927 |
| Validation evidence | Repeatedly used development partition; no untouched final test | Published genetic and functional benchmarks | Published independent test sets | Published clinical-label and functional-assay comparisons | Published population, patient-cohort and functional benchmarks | — | — |
| Practical use | GPU model execution; verified batch-32 workflow | Precomputed score lookup | Precomputed score lookup | Precomputed lookup for covered proteins | Licensed score access | — | — |
| Compute evidence in our project | 3.67 h continuation experiment; 27.27 GiB peak GPU allocation | 1.2 min lookup/evaluation | 1.8 min lookup/evaluation | 5.5 s aggregation/evaluation | No measurement | 13.0 s | 12.4 s |
| Main strength | Complete local coverage, inspectable adaptation and explicit leakage checks | Strong performance with protein-specific context | Strongest reported discrimination in our comparison | Clinical-label-independent evolutionary modeling | Broad tolerated-variation training and external evaluation | — | — |
| Main limitation here | Lower discrimination; no calibrated clinical probabilities; batch sensitivity | Missing scores and unresolved ClinVar calibration overlap | Possible disease-training and constituent-model overlap | Substantial missing coverage | Cannot assess performance on our cohort | — | — |
| Evaluated method and sources | [Evo2 7B Q16 continued LoRA (blocks 29 and 30, rank 8, 512 bp)](notebooks/Q16-lora-continuation.ipynb) | [AlphaMissense](notebooks/Q8-existing-tools.ipynb) ([paper](https://doi.org/10.1126/science.adg7492)) | [REVEL](notebooks/Q8-existing-tools.ipynb) ([paper](https://doi.org/10.1016/j.ajhg.2016.08.016)) | [EVE](notebooks/Q8-existing-tools.ipynb) ([paper](https://doi.org/10.1038/s41586-021-04043-8)) | [PrimateAI-3D (licensed)](notebooks/Q8-existing-tools.ipynb) ([paper](https://doi.org/10.1126/science.abn8197)) | [SIFT4G](notebooks/Q8-existing-tools.ipynb) ([paper](https://doi.org/10.1038/nprot.2015.123)) | [PolyPhen-2](notebooks/Q8-existing-tools.ipynb) ([paper](https://doi.org/10.1038/nmeth0410-248)) |
| Score source in this project | [Q16 continued LoRA checkpoint](notebooks/Q16-lora-continuation.ipynb); local GPU inference | [2023 GRCh38 release](data/README.md#q8-alphamissense-scores); `am_pathogenicity` | [REVEL v1.3](data/README.md#q8-revel-scores); continuous REVEL score | [dbNSFP4.9a](data/README.md#q8-sift4g-polyphen-2-and-eve-scores); continuous `EVE_score`, without confidence-category filtering | [Licensed scores](data/README.md#q8-primateai-3d-access); unavailable to this project | [dbNSFP4.9a](data/README.md#q8-sift4g-polyphen-2-and-eve-scores); `1 - SIFT4G_score` | [dbNSFP4.9a](data/README.md#q8-sift4g-polyphen-2-and-eve-scores); `Polyphen2_HVAR_score` |
